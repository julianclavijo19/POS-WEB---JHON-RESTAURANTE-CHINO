  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Historial de Cobros</h1>
                ...
                return (
                  <div key={payment.id} className="p-4 flex items-center justify-between hover:bg-gray-50">
                    ...
                    <div className="text-right">
                      ...
                      {payment.method?.toUpperCase() === 'CASH' && payment.received_amount && (
                        <p className="text-xs text-gray-500">
                          Recibido: {formatCurrency(payment.received_amount)}
                        </p>
                      )}
                    </div>
                  </div>
