                    ...
                    return (
                      <tr key={register.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${register.register_type === 'FAST_FOOD'
                            ? 'bg-orange-100 text-orange-800'
                            : 'bg-gray-100 text-gray-800'
                            }`}>
                            {register.register_type === 'FAST_FOOD' ? '🍔 Comidas Rápidas' : '🍜 Restaurante'}
                          </span>
                        </td>
                        <td className="px-4 py-3">
